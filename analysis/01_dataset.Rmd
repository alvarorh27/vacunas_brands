...
saveRDS(
  poblacion_diana3, 
  file = "~/projects/vacunas_brands/Rfiles/poblacion_diana3.rds"
)
...
saveRDS(
  infect_covid5, 
  file = "~/projects/vacunas_brands/Rfiles/infect_covid5.rds"
)
...
saveRDS(
  pupa2, 
  file = "~/projects/vacunas_brands/Rfiles/pupa2.rds"
)
...
saveRDS(
  episodios_cmbd, 
  file = "~/projects/vacunas_brands/Rfiles/episodios_cmbd.rds"
)
...
write.table(tabla_ordenada, file = "~/projects/vacunas_brands/figures/combined_vaccines.csv", sep = ":", col.names = TRUE, row.names = TRUE, quote = FALSE)
print(tabla_ordenada)

saveRDS(
  vacunas3, 
  file = "~/projects/vacunas_brands/Rfiles/vacunas3.rds"
)
...
episodios_cmbd <- readRDS("~/projects/vacunas_brands/Rfiles/episodios_cmbd.rds")
infect_covid5 <- readRDS("~/projects/vacunas_brands/Rfiles/infect_covid5.rds")
poblacion_diana3 <- readRDS("~/projects/vacunas_brands/Rfiles/poblacion_diana3.rds")
pupa2 <- readRDS("~/projects/vacunas_brands/Rfiles/pupa2.rds")
vacunas3 <- readRDS("~/projects/vacunas_brands/Rfiles/vacunas3.rds")
...
estudio_vacunas_t_final_selected %<>%
  ...
  mutate(across(shot_1:combined_vaccines, ~ if_else(is.na(.x), "None", .x))) %>%
  mutate(across(shot_1:combined_vaccines, ~ as.factor(.x))) %>%
  mutate(across(shot_1:combined_vaccines, ~ relevel(.x, ref = "None"))) %>%
  mutate(
...
saveRDS(
  estudio_vacunas_t_final_selected, 
  file = "~/projects/vacunas_brands/Rfiles/estudio_vacunasbrands_t_final_selected_manuscript.rds"
)

saveRDS(
  variants_week_spain_labels,
  file = "~/projects/vacunas_brands/Rfiles/variants_week_spain_labels.rds",
)
```
