...
```{r}
estudio_vacunasbrands_t_final_selected_manuscript <- (
  readRDS(
...
vars_in_table1<-c('hosp_stay_bin', 'group_vaccines', 'european_vaccines') 
...
table1_dataset <- estudio_vacunasbrands_t_final_selected_manuscript[,vars_in_table1]
...
```{r}
# Lists the variables we are going to be including in table1 (except for the stratification variable)
vars_in_table1<-c('icu_stay_bin', 'group_vaccines', 'european_vaccines') 
...
```{r}
# Lists the variables we are going to be including in table1 (except for the stratification variable)
vars_in_table1<-c('mortality30d', 'group_vaccines', 'european_vaccines') 
